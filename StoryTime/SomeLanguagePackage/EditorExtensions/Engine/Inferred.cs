...
namespace SOME.SomeLanguageService.EditorExtensions
{
    ...
    public class ReflectedModule : Inferred
    {
        ...
        public void AddSomeType(string name, Type type)
        {
            AddType(name, new InferredSomeType(type));
        }
    ...
    public class InferredSomeType : ReflectedType
    {
        public InferredSomeType(Type type)
            : base(type)
        {
        }
        ...
        protected override void Initialize()
        {
            ...
            foreach (MemberInfo info in infos)
            {
                object[] attrs = info.GetCustomAttributes(typeof(PythonNameAttribute), false);
                if (attrs == null || attrs.Length == 0) continue;
                PythonNameAttribute attr = attrs[0] as PythonNameAttribute;
    ...
    public class FunctionDefinitionInfo : FunctionInfo
    {
        ...
        public FunctionDefinitionInfo(FunctionDefinition function)
        {
