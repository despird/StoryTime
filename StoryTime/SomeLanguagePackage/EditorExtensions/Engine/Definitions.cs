...
namespace SOME.SomeLanguageService.EditorExtensions
{
    ...
    public class SomeClassDefinition : Definition
    {
        private ClassDefinition @class;
        public SomeClassDefinition(ClassDefinition @class)
        {
            this.@class = @class;
        }
    ...
    public class SomeFunctionDefinition : Definition
    {
        private FunctionDefinition function;
        public SomeFunctionDefinition(FunctionDefinition function)
        {
            this.function = function;
        }
