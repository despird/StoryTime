...
namespace SOME.SomeLanguageService.EditorExtensions
{
    public class Engine
    {
        ...
        public IList<Inferred> Infer(Node node, Scope scope)
        {
            ...
            {
                inferred = InferClassDef((ClassDefinition)node, scope);
            }
            ...
            {
                inferred = InferFuncDef((FunctionDefinition)node, scope);
            }
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA1801", MessageId = "scope")]
        private List<Inferred> InferClassDef(ClassDefinition node, Scope scope)
        {
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA1801", MessageId = "node")]
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA1801", MessageId = "scope")]
        private List<Inferred> InferFuncDef(FunctionDefinition node, Scope scope)
        {
