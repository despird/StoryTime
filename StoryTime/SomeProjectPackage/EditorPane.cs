...
namespace SOME.SomeProjectPackage
{
    ...
    //     - An empty sms file in the same directory as NewFileItems.vsdir. In
    //       our case we chose .sms.sms. Note this file name appears in Editor.vsdir
    ...
    //          - ".sms" - This is the base file name. New files will initially
    //             be named as .sms1.sms, .sms2.sms... etc.
    ///////////////////////////////////////////////////////////////////////////////
    // Editor.vsdir contents:-
    //    .sms.sms|{3085E1D6-A938-478e-BE49-3546C09A1AB1}|#106|80|#109|0|401|0|#107
    //
    // The fields in order are as follows:-
    //    - .sms.sms - our empty sms file
                                ...
                                IVsToolboxUser      //Sends notification about Toolbox items to the owner of these items
    {
        ...
        private const string MyExtension = ".sms";
        ...
        #region Fields
        private SomeProjectPackage myPackage;
        ...
        public EditorPane(SomeProjectPackage package)
            : base(null)
        {
            PrivateInit(package);
        }
        ...
        /// <summary>
        /// Initialization routine for the Editor. Loads the list of properties for the sms document 
        /// which will show up in the properties window 
        /// </summary>
        /// <param name="package"></param>
        private void PrivateInit(SomeProjectPackage package)
        {
            myPackage = package;
            loading = false;
        ...
        private void setupCommands()
        {
            ...
            if (null != mcs)
            {
                ...
                //addCommand(mcs, GuidList.guidSomeProjectPackageCmdSet, (int)PkgCmdIDList.icmdStrike,
        ...
        private void DisplayContextMenuAt(Point point)
        {
            ...
            //CommandID contextMenuID = new CommandID(GuidList.guidSomeProjectPackageCmdSet, PkgCmdIDList.IDMX_RTF);
