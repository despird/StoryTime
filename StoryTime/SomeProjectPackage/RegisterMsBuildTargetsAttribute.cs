...
namespace SOME.SomeProjectPackage
{
    public class RegisterMsBuildTargetsAttribute : RegistrationAttribute
    {
        ...
        {
            if (context == null) throw new ArgumentException("Bad context to register Some MsBuild task.");
        ...
        {
            if (context == null) throw new ArgumentException("Bad context to unregister Some MsBuild task.");
