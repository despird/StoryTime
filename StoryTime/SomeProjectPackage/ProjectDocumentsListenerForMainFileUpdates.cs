...
namespace SOME.SomeProjectPackage
{
    ...
    class ProjectDocumentsListenerForMainFileUpdates : ProjectDocumentsListener
    {
        ...
        /// </summary>
        private SomeProjectNode project;
        #endregion

        #region ctors
        public ProjectDocumentsListenerForMainFileUpdates(ServiceProvider serviceProvider, SomeProjectNode project)
        ...
        public override int OnAfterRenameFiles(int cProjects, int cFiles, IVsProject[] projects, int[] firstIndices, string[] oldFileNames, string[] newFileNames, VSRENAMEFILEFLAGS[] flags)
        {
            ...
            //string currentMainFile = this.project.GetProjectProperty(SomeProjectFileConstants.MainFile, true);
