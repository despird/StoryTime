...
namespace SOME.SomeProjectPackage
{
    ...
    /// </summary>
    [Guid(GuidList.guidSomeProjectPackageEditorFactoryString)]
    public sealed class EditorFactory : IVsEditorFactory, IDisposable
    {
        private SomeProjectPackage editorPackage;
        private ServiceProvider vsServiceProvider;


        public EditorFactory(SomeProjectPackage package)
        {
                        ...
                        out int pgrfCDW)
        {
            ...
            pguidCmdUI = GuidList.guidSomeProjectPackageEditorFactory;
            pgrfCDW = 0;
