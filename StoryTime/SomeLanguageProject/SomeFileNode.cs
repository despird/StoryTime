...
namespace SOME.SomeLanguageProject
{
    public class SomeFileNode : FileNode
    {
        ...
        {
            return base.CreatePropertiesObject();
        ...
        {
            //TODO:
            Debug.Assert(this.ProjectMgr != null, "The SomeProjectNode has no project manager");
        ...
        {
            //TODO: using (SomeProjectNode)this.ProjectMgr to get the project node.
